...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfo(
				"Tiny E-Commerce",
				"PoC Tiny E-Commerce: Springboot + H2 + REST API application Catalog, Shopping Cart, Checkout, Orders, Security.",
				"0.0.1-SNAPSHOT",
				"All rights otorged",
				new Contact("Agustín Jiménez Fernández", "https://www.mhp.es/", "agustinjf87@gmail.com"),
				"API license",
				"https://www.mhp.es/",
